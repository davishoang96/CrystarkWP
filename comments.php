        ...
        <?php else : //this is where we setup the comment input forums ?>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" />
              ...
              <div class="form-group"><textarea class="form-control" name="comment" id="comment" tabindex="4"></textarea></div>

              <p><input class="btn btn-success" name="submit" type="submit" id="submit" tabindex="5" col="" value="Post" />
